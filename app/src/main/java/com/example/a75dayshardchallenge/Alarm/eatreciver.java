...
public class eatreciver extends Worker {
    ...
    public eatreciver(@NonNull Context context, @NonNull WorkerParameters workerParams) {
    ...
    private void showNotification() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            NotificationManagerCompat.from(getApplicationContext()).createNotificationChannel(new NotificationChannel("eathealthyyy", "Eat", NotificationManager.IMPORTANCE_DEFAULT));
        }
